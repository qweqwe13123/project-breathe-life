(function () {
  ...
  var I18N = {
    en: {
      ...
      plan49_name: "Resume Review",
      plan49_intro: "Get professional feedback on your current resume before applying.",
      plan49_features: [
        "Detailed review from a resume specialist",
        "Identify mistakes that may be blocking interviews",
        "ATS compatibility check",
        "Personalized improvement recommendations"
      ],
      plan49_best: "People who already have a resume and want expert feedback before applying.",
      plan249_name: "Resume Rewrite",
      plan249_intro: "Increase your chances of getting interviews with a complete professional rewrite.",
      plan249_features: [
        "Everything included in Resume Review",
      ...
      plan549_name: "Premium Career Support",
      plan549_intro: "Our most complete package designed to maximize your chances of landing better opportunities.",
      plan549_features: [
        "Everything included in Resume Rewrite",
        "Premium LinkedIn profile optimization",
        "1-on-1 interview coaching session",
        "Personalized job search strategy",
        "Salary negotiation guidance",
        "Priority support and faster delivery",
        "Direct recommendations to improve hiring potential"
      ],
    ...
    es: {
      ...
      plan49_name: "Revisión de currículum",
      plan49_intro: "Recibe retroalimentación profesional sobre tu currículum actual antes de postularte.",
      plan49_features: [
        "Revisión detallada por un especialista en currículums",
        "Identifica errores que pueden estar bloqueando entrevistas",
        "Verificación de compatibilidad con sistemas ATS",
      ...
      plan249_name: "Reescritura de currículum",
      plan249_intro: "Aumenta tus posibilidades de conseguir entrevistas con una reescritura profesional completa.",
      plan249_features: [
        "Todo lo incluido en Revisión de currículum",
        "Reescritura completa optimizada para ATS",
        "Formato y estructura profesional",
        "Contenido enfocado en logros que atrae a reclutadores",
        "Soporte bilingüe (inglés y español)",
        "Entregado listo para postular"
      ],
      plan249_best: "Personas que buscan un currículum competitivo que destaque en el mercado laboral de EE. UU.",
      plan549_name: "Soporte Premium de carrera",
      plan549_intro: "Nuestro paquete más completo, diseñado para maximizar tus oportunidades laborales.",
      plan549_features: [
        "Todo lo incluido en Reescritura de currículum",
        "Optimización premium del perfil de LinkedIn",
        "Sesión 1:1 de coaching de entrevistas",
        "Estrategia personalizada de búsqueda de empleo",
        "Guía de negociación salarial",
        "Soporte prioritario y entrega más rápida",
        "Recomendaciones directas para mejorar tu potencial de contratación"
      ],
  ...
  document.getElementById('tl-next').addEventListener('click', function () {
    ...
    if (isFinal) {
      ...
      var url = plan === '49' ? 'https://buy.stripe.com/test_bJe7sN5JzaAYeO1frk4gg00'
        : plan === '249' ? 'https://buy.stripe.com/test_aFabJ3god5gEbBPcf84gg01'
        : 'https://buy.stripe.com/test_cNieVfeg5gZm9tHdjc4gg02';
